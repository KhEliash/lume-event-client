...
//         <h1 className="mt-4 text-2xl font-bold text-yellow-600">{message}</h1>
...
//           </a>
//           <a
//             href={`/payment/retry?transactionId=${transactionId}`}
...
import Cancel from "@/app/(dashboardLayout)/(userDashboardLayout)/dashboard/payments/cancel-client";
